...
namespace Posterno\Elementor\Documents;
...
class Listing extends Single {
	...
	public static function get_properties() {
		...
		$properties['condition_type'] = 'listings';
	...
	public static function get_title() {
		return esc_html__( 'Single listing', 'posterno-elementor' );
	}
